...
def activityPayload = '''
{
    ...
    "dueDate": "2022-12-31T23:59:59Z",
    "completed": false
}
'''

def postActivityRequest = findTestObject("Object Repository/FakeRESTApi_Web V1/_api_v1_Activities/POST")
def postActivityBodyContent = new HttpTextBodyContent(replaceSuffixWithUUID(activityPayload))
postActivityRequest.setBodyContent(postActivityBodyContent)
...
println("Step 2 - Response Status Code: " + postActivityResponse.getStatusCode())
