...
WS.verifyElementPropertyValue(response, 'data.findAllBooks[0].title', &quot;Awakening&quot;)
WS.verifyElementPropertyValue(response, 'data.findAllBooks[0].pageCount', 454)
WS.verifyElementPropertyValue(response, 'data.findAllBooks[1].author.firstName', &quot;El&quot;)</verificationScript>
