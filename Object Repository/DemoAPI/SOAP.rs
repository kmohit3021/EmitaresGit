...
<WebServiceRequestEntity>
   ...
   <name>SOAP</name>
   <tag></tag>
   <elementGuidId>8789cc4e-ffcf-470c-be8d-a441c148b4ff</elementGuidId>
   ...
   <httpHeaderProperties>
      ...
      <webElementGuid>57c37a59-1b77-413f-a392-8f040396daaf</webElementGuid>
   </httpHeaderProperties>
...
WS.verifyElementText(response, 'ListOfContinentsByNameResponse.ListOfContinentsByNameResult.tContinent[0].sName', 'Africa')
WS.verifyElementText(response, 'ListOfContinentsByNameResponse.ListOfContinentsByNameResult.tContinent[2].sName', 'AS')
WS.verifyElementText(response, 'ListOfContinentsByNameResponse.ListOfContinentsByNameResult.tContinent[3]', 'Asia')
